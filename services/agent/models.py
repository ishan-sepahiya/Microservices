"""
models.py — Agent Service ORM + Pydantic schemas
"""
import uuid, enum
...
class RegisteredService(Base):
    ...
    status:        Mapped[ServiceStatus]   = mapped_column(Enum(ServiceStatus), nullable=False, default=ServiceStatus.HEALTHY)
...
class ServiceInstruction(Base):
    ...
    set_by:       Mapped[str]       = mapped_column(String(50), nullable=False, default="system")
    created_at:   Mapped[datetime]  = mapped_column(DateTime(timezone=True), default=_utcnow, nullable=False)
