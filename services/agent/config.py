...
class Settings(BaseSettings):
    ...
    # Key that all services send in X-Control-Key header to register
    # Can be set via CONTROL_API_KEY or AGENT_API_KEY env var (both mapped)
    control_api_key: str = "change-me-agent-internal-key"
